...
The rapid development of multimodal Large Languge Models (LLMs) has enabled a \dots
\textcolor{blue}{ha abierto un abanico de posibilidades a nuevas aplicaciones. Entre ellas destaca el de la smart agriculture, con grandes avances en agricultura de precisión... El surgimiento de los geofoundation models [papers] y los earth embeddings [papers], así como el veloz avance de los propios modelos de lenguaje, destacando especialmente los open source, son realmente prometedores en el campo de earth observation y smart agriculture. En los últimos años han surgido una gran cantidad de estudios acerca de cómo aplicar la IA generativa al campo, pasando en muchos casos por asistentes conversacionales [papers]. Estos estudios en muchos casos utilizan RAG, geoembeddings o aplicaciones más "clasicas" como segmentación semántica sobre datos, en la mayoria de los casos, satelitales. 
Sin embargo, en la mayoría de los casos, las respuestas obtenidas de estas nuevas herramientas siguen siendo, aunque mucho más precisas y utilizando nuevas fronteras... genéricas. Recientemente nosotros hemos propuesto una herramienta que permite generar respuestas acerca del terreno para su aplicación a la agricultura que sean específicas al terreno AoI -> gracias a la recuperación, procesamiento y fusión de distintas fuentes multi-dominio de datos abiertas. Una vez esta herramienta ha sido validada técnicamente, es cuando surge el reto al que nos enfrentamos en este trabajo, el de evaluar las respuestas. La evaluación de las respuestas de IA generativa lleva siendo desde el origen de la misma, una de las principales lineas de investigación abiertas, ya que es común a toda aplicación que utilice inferencia no determinista.  A diferencia del ML... aquí las respuestas correctas forman un espacio infinito... Existen muchas alternativas, como LLM-as-a-judge [paper], que fue el approach utilizado en [paper] . Esta téncnica, aunque muy extendida gracias a su simplicidad y bajo coste operativo, is highly vulnerable to technical hallucinations, suffers from self-reference bias, and tends to lose consistency. para las aplicaciones de RAG, existen frameworks como RAGAS... tambien se ha investigado mucho las métricas que optimizan la evaluación... En nuestro caso, dado que la herramienta tiene la particularidad de que tiene contexto amplificado con fuentes externas, ninguno de los frameworks de evaluación encontrados en la literatura se ajustan a nuestras necesidades, por lo que en este trabajo proponemos una novel metodología de evaluación para LLMs multimdoales de contexto amplificado aplicados a datos de agricultura. Esta metodología es reproducible... multietapa, híbrida, mitiga sesgos etc}
