...
This section presents the results drawn from the evaluation of the 4 judges over the 143 queries along the 5 metrics, divided into the broad evaluation and the ablation study. Firstly, \ref{tab:resuls_broad} contains the average scores of all 71 broad evaluation queries \textcolor{red}{meter (+- std) en la tabla?}.  
...
\subsection{Without Context Metrics}

Table \ref{tab:without_context} outlines the metrics used to evaluate responses without relying on external context: Correctness, Completeness, Relevance, and Utility.

\begin{table*}[t]
    \centering
    \caption{Assessment Metrics Without Context}
...
\subsection{With Context Metrics}

Table \ref{tab:with_context} details the grounding metric, which evaluates the response based on the provided external context.

\begin{table*}[t]
    \centering
    \caption{Assessment Metrics With Context}
    \label{tab:with_context}
